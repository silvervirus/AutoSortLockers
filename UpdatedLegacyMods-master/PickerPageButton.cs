...
namespace AutosortLockers
{
    public class PickerPageButton : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        {
            if (canChangePage && enabled && (eventData.button == PointerEventData.InputButton.Right) || (eventData.button == PointerEventData.InputButton.Left) || (GameInput.GetKeyDown(KeyCode.Joystick1Button1)))
            {
