...
namespace Common.Mod
{
    internal class Utilities
    {
        ...
        public static PrefabInfo CreatePrefabInfo(string id, string name, string description, Sprite sprite, int sizeX = 0, int sizeY = 0)
        {
            return PrefabInfo
                .WithTechType(id, name, description)
                .WithIcon(sprite)
        ...
        public static PrefabInfo CreateBuildablePrefabInfo(string id, string name, string description, Sprite sprite)
        {
            return PrefabInfo
                .WithTechType(id, name, description)
                .WithIcon(sprite);
