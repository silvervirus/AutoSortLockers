...
namespace AutosortLockers
{
    public class AutosortTypePicker : MonoBehaviour
    {
        ...
        public void RefreshCurrentFilters()
        {
        ...
        public void refreshHiddenFilters()
        {
        ...
        public List<AutosorterFilter> GetAvailableTypes()
        {
        ...
        public void ChangePage(int pageOffset)
        {
        ...
        public void OnCategoriesButtonClick(AutosorterFilter obj, PickerButton b)
        {
            if (currentMode != Mode.Categories)
            {
        ...
        public void OnItemsButtonClick(AutosorterFilter obj, PickerButton b)
        {
